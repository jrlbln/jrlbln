...
export function CredentialsPanel() {
  ...
  return (
    <PanelFrame className="items-center">
      <div className="max-w-[52rem] flex h-full flex-col">
        ...
        <div className="flex flex-1 flex-col">
          <div className="flex min-h-[220px] items-start">
            <h1 className="max-w-[22ch] text-[clamp(2.8rem,4.4vw,4.3rem)] font-semibold leading-[0.92] tracking-[-0.08em] text-[var(--color-text)]">
              {panel.title}
            </h1>
          </div>
